...
(function () {
    ...
    function createLogElem() {
        ...
        var css = '.' + logElemClassName + '{position:absolute;top:0;left:0;width:100%;max-height:105px;-webkit-box-sizing:border-box;box-sizing:border-box;font:12px Courier New;background-color:rgba(255,255,255,0.4);word-wrap:break-word;word-break:break-all;overflow-y:scroll;padding:5px;z-index:999999;}';
